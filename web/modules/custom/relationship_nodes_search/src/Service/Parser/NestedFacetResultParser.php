 ...
 * 
 * Handles extraction and normalization of facet data from
 * Elasticsearch aggregation responses and Search API results.
 */
class NestedFacetResultParser {

    /**
     * Extract facet values from Search API results.
     *
