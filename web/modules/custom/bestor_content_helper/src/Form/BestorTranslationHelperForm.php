...
class BestorTranslationHelperForm extends ConfigFormBase {
  ...
  public static function create(ContainerInterface $container) {
    return new static(
      $container->get('bestor_content_helper.custom_translations')
    );
  }
  ...
  protected function getEditableConfigNames() {
    return ['bestor_content_helper.translations'];
  }
  ...
  public function getFormId() {
    return 'bestor_content_helper_translations';
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    $config = $this->config('bestor_content_helper.translations');
    ...
    $form['description'] = [
      ...
      '#suffix' => '<p><strong>' . $this->t('To add new translation keys, edit: <code>bestor_content_helper/src/Service/CustomTranslations.php</code> → getDefinitions()') . '</strong></p></div>',
    ];
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $this->config('bestor_content_helper.translations')
